...
public class MoreWindow extends PopupWindow implements View.OnClickListener {
    ...
    public void setListenner(OnClickListener onClickListener) {
    ...
    public void showMoreWindow(View anchor, int bottomMargin) {
        ...
        /*ImageView close= (ImageView)layout.findViewById(R.id.running);
        */
        TextView library=(TextView)layout.findViewById(R.id.library);
        ...
        TextView running=(TextView)layout.findViewById(R.id.running);
        ...
        TextView classTable=(TextView)layout.findViewById(R.id.class_table);

        classTable.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                onClickListener.onClick(v);
            }
        ...
        params.addRule(RelativeLayout.BELOW, R.id.class_table);
        params.addRule(RelativeLayout.RIGHT_OF, R.id.library);
